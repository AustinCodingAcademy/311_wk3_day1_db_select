...
3.
  ...
  * What's the last email on the list: nichelle_meteer@meeter.com
  ...
  I would rather use SQL, especially when the data gets larger. Not only are you learning a skill by using SQL, but you are saving loads of time in the future when you need to search through another database.